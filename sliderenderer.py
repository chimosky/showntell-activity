...
class Renderer(object):
    ...
    def getSlideDimensionsFromFirstLayer(self, n=None):
        ...
        # This may be optimizable to avoid having to open the
        # first layer to get its size, or at least keeping it around
        # to re-use it when the slide is first rendered
        if ftype == "svg":
